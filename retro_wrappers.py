# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 20:31:00 2018
...
def wrap_deepmind_retro(env, scale=True, frame_stack=4):
    ...
    """
    env = WarpFrame(env) # Warp frames to 84x84
    env = ClipRewardEnv(env) # clips the reward to {+1, 0, -1} by its sign.
    env = FrameStack(env, frame_stack) # Returns lazy array, which is much more memory efficient.
    if scale:
